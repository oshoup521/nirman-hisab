...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-md border-t border-slate-100 px-1 pt-2 pb-[max(10px,env(safe-area-inset-bottom))] flex justify-around items-end z-50 shadow-[0_-4px_20px_rgba(0,0,0,0.06)]">
